...
<div style="font-family: 'JetBrains Mono', monospace; color: #888; max-width: 500px; margin: 4rem auto; text-align: center;">
...
<!-- The coordinates below are for Layer 1 of The Pattern.
     Encoded in base64 because the curious will check source.
     TGF5ZXIgMTogMzUuNDcyOSAtOTcuNTE3MSBrZXl3b3JkOiBQRU5ST1NFLiBHbyB0aGVyZS4gTG9vayBkb3duLg==
-->

<script>
// For the technically curious: this page rewards inspection.
// The carrier text above contains zero-width Unicode characters.
// Copy it, paste into a Unicode inspector, or decode with:
// python3 -c "import sys; t=sys.stdin.read(); print(''.join(chr(int(b,2)) for b in ''.join('1' if c=='\u200c' else '0' for c in t if c in '\u200b\u200c').split('\u200d') if len(b)==8))"
</script>
