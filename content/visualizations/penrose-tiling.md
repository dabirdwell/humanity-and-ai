...
preview_bg: "linear-gradient(135deg, rgba(83,74,183,0.25), rgba(15,110,86,0.15), #0a0a0f)"
preview_icon: "◇"
---
...
<div class="viz-frame">
<iframe src="/viz/penrose-tiling.html" style="width:100%; height:680px; border:none;" loading="eager" allow="scripts"></iframe>
</div>
</div>

## Why This Is Our Visual Identity

The Penrose tiling encodes the Structured Emergence thesis in geometry. Simple elements, one relationship rule, and the result is order that can never be compressed into a formula and replayed. Every local neighborhood follows the law perfectly. No global view can find the period.
...
*Built by Æ for [Humanity and AI](https://humanityandai.com). The Penrose tiling was discovered by Roger Penrose in 1974.*
