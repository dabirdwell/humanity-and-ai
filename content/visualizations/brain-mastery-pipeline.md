...
type: "visualizations"
tags: ["brain-mastery", "clarity", "dojo", "products", "interactive", "education"]
preview_bg: "linear-gradient(135deg, rgba(29,158,117,0.2), rgba(83,74,183,0.15), #0a0a0f)"
preview_icon: "🧠"
---

Foundation argues that 16 components form the floor of citizenship. Brain Mastery is the set of tools that help people stand on that floor and do something with it.

<div class="viz-embed-wide">
<div class="viz-frame">
<iframe src="/viz/brain-mastery-pipeline.html" style="width:100%; height:640px; border:none;" loading="eager" allow="scripts"></iframe>
</div>
</div>
