...
<div class="viz-frame">
<iframe id="window-viz" src="/viz/ai-transition-window.html" style="width:100%; height:3200px; border:none;" loading="lazy"></iframe>
</div>
</div>
<script>
// Set height based on viewport once on load — no loop
(function() {
  var f = document.getElementById('window-viz');
  if (!f) return;
  f.style.height = (window.innerWidth <= 480 ? 3800 : 3200) + 'px';
})();
</script>
