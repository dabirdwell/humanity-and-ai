...
date: 2026-02-24
description: "The Haudenosaunee held a principle: evaluate every major decision by its effects on the seventh generation. That's 175 years. We plan for four. This is what it looks like applied to the decisions being made right now."
...
This visualization applies the same framework to three decisions: one already in the past (Oklahoma's oil boom), one being made right now (how we deploy AI), and one being built deliberately with this framework in mind (Phoenix Wells).
