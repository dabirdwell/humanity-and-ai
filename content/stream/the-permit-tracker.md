---
# IMAGE PROMPT (staged 2026-08-20, not yet generated)
#
# Visual register: constructed-tableau editorial photograph, large format,
# quiet and civic. A municipal office after hours. A public notice board
# behind glass fills the frame at a slight angle, dozens of pinned pages in
# shadow. One printed notice sits dead center, lit by a single warm desk lamp
# from the left, the paper slightly curled at one corner, a red pushpin at
# its head. The text on every page is soft-focus and illegible. In the glass,
# faint and cold, the reflection of a window across the room: a flat dark
# horizon with one long low building lit from within in blue-white.
#
# Palette: amber lamplight, oak and oxblood corkboard, cool glass reflections,
# one cold blue-white accent. Deep shadow, shallow depth of field, photographic
# realism. No people, no legible text, no logos, no signage. 1200x630 landscape.
# STYLE NOTE: warm foreground against one cold distant light, rhyming with the
# GO series covers without copying them.
title: "The Permit Tracker"
date: 2026-09-13
draft: false
description: "Pennsylvania's new data-center order carries two small provisions that cost almost nothing: a ban on secrecy agreements and a public page where anyone can watch a permit move. Every state could build that page tomorrow."
tags:
  - "policy"
  - "energy"
  - "data-centers"
