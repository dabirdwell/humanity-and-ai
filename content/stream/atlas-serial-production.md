---
# IMAGE PROMPT (staged 2026-08-15, not yet generated)
#
# Visual register: constructed-tableau still life photography, large format,
# lit in the language of a 17th century Dutch vanitas. One raking window light
# from the left, deep falloff into near black, extreme surface detail.
#
# Subject: a machinist's scarred steel workbench, shot dead level with the
# bench surface. Laid out left to right in precise exploded-assembly order are
# the parts of an automotive electric power steering actuator: the brushed
# steel motor housing, the helical gearbox with its teeth catching the light,
# a copper position-sensor ring, the controller block. To the right of the last
# part, in the exact position where the next component in the sequence belongs,
# sits a single worn leather work glove, palm up and empty, fingers curled into
# precisely the volume the missing joint would occupy. A fine layer of red clay
# dust has settled over the whole bench, heavier on the glove than on the metal.
#
# Palette: oxidized steel grey, warm brass and copper, oxblood leather, and the
# specific orange red of Georgia and Oklahoma clay. No blue anywhere. No teal.
#
# Focus: shallow depth of field falling off past the gearbox. The glove is the
# sharpest object in the frame.
#
# Hard exclusions: no text, no letters, no numerals, no logos, no signage, no
# labels on any component. No robots. No human figures. No screens. No server
# rooms or corridors. No circuit traces. No network lines. No gradients.
#
# Aspect ratio: 16:9 for the site cover. Render a 1.91:1 crop for social.
#
# Why this image: the hinge of the argument is that the car part was already on
# the shelf. The glove is the hand it replaces. The clay is the two states where
# it lands.
...
We track the Oklahoma side of that in [The Inference](https://humanityandai.com/inference/), every issue, by bill number.
