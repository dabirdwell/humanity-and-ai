---
title: "Accessible Education & Training"
description: "Free, lifelong access to learning at every level. Not retraining programs after your industry dies — continuous development as a right."
number: "10"
weight: 10
status: "seed"
...
Oklahoma's numbers tell the story in miniature. The state ranks near the bottom nationally in education funding per pupil. Teacher pay ranks in the bottom five, driving an ongoing teacher shortage — over 3,000 teachers on emergency certificates (meaning they're teaching without full training, because there's nobody else) filling positions in any given year because qualified teachers leave for states that pay them. Rural school districts are consolidating or closing. Community colleges are cutting programs. The infrastructure of accessible education is hollowing out precisely when the economy demands more of it, not less.

Retraining programs — the policy solution that gets proposed every time automation eliminates a category of jobs — have a dismal track record. The Trade Adjustment Assistance program — the federal government's main retraining effort for workers who lose jobs to outsourcing or automation — consistently shows that only about a third of participants find jobs in their trained field. The rest cycle through programs that check a policy box without changing an outcome. Mike's eight-month wait for a six-month program that led to jobs that no longer existed isn't a failure of the program. It's the program working exactly as designed — reactive, slow, disconnected from the labor market it claims to serve.
...
This connects directly to [mental health](/foundation/mental-health/) — financial stress from education debt is associated with higher rates of anxiety, depression, and delayed life milestones. People postpone marriage, children, home purchases, and retirement because of student loans. The stress isn't a side effect. It's the primary experience of the system for millions of Americans.

It connects to [housing](/foundation/housing/) — the generation carrying the most student debt is the generation least able to afford homes. The median age of first-time home buyers has risen to 36, the highest on record. Student debt is cited as the primary barrier by over half of non-homeowning millennials.

It connects to the [social contract](/foundation/social-contract/) — when the deal was "get educated and you'll have a pathway to stability," and the education produces debt instead of stability, trust in the whole system erodes. Renee did everything the contract asked. The contract didn't hold up its end.

And it connects to [UBI](/foundation/universal-basic-income/) — because economic security is what makes lifelong learning possible. You can't go back to school at 45 if missing a paycheck means missing rent. The financial floor that Foundation provides is what turns education from a one-shot gamble into a lifelong resource.
