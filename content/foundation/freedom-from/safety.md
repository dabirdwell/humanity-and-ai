...
weight: 1
status: "seed"
tags: ["foundation", "safety", "community", "foundation", "policy"]
hero_stat: "Oklahoma locks up more people per person than any state in the nation — and any country on earth. Meanwhile, 24 people per minute experience intimate partner violence, and community violence intervention programs cost a fraction of policing. We chose the expensive failure."
...
Foundation is built on a simple premise: there is a minimum set of conditions people need to thrive, and a society wealthy enough to provide them has no excuse not to. Safety is the first of [sixteen components](/foundation/) — not because it's the most complex, but because everything else rests on it. You can't learn if you're afraid. You can't create if you're surviving. You can't participate in your own democracy if your daily life is organized around avoiding harm.

## The System We Built Instead

We built prisons. More than anyone else on earth.

Oklahoma incarcerates more people per person than any other state — and any other country. Not compared to countries with similar crime rates. Per person, period. More than Mississippi. More than Louisiana. More than El Salvador. Oklahoma's incarceration rate is approximately 1,079 per 100,000 people. The national average is roughly 664. The state has been at or near the top of this ranking for over a decade, and the reforms that briefly bent the curve — like State Question 780 in 2016, a ballot measure that reclassified some drug and property offenses as misdemeanors instead of felonies — have been systematically undermined by later laws that restored mandatory minimum sentences and expanded prosecutors' power to charge harder.

What has this produced? Not safety. Oklahoma's violent crime rate remains above the national average. Property crime remains above the national average. And here's the number that tells you the system isn't working: roughly three out of four people released from Oklahoma prisons are arrested again within five years. We're spending about $34,000 per year to lock each person up, and three-quarters of them come back. That's not a safety system. That's a revolving door with a $34,000 turnstile.
...
Oklahoma's firearm death rate is among the highest in the nation — consistently in the top ten. The state has loosened gun regulations steadily over the past decade: permitless carry (meaning you no longer need training or a license to carry a concealed weapon), stand-your-ground expansion (laws that allow lethal force if you feel threatened, with no duty to walk away first), and laws that block cities and towns from setting their own gun rules — even if local voters want stricter standards. The theory was that more guns in more hands would produce more safety. The data says otherwise. States with weaker gun laws consistently have higher rates of gun death.

This is not an argument about the Second Amendment. It's an observation about infrastructure. We have chosen — through specific policy decisions made by specific people — to treat firearms as a consumer product rather than a public health variable. The result is 43,000 deaths a year in the richest country on earth. Other wealthy nations have mental illness. They have poverty. They have every social problem we blame for our violence. They don't have this. The variable is the policy.
...
Community violence intervention — that's a mouthful, but the idea is simple: trained local people who know the neighborhood identify conflicts before they become shootings and step in with relationships, not badges. These programs have produced dramatic results everywhere they've been seriously funded. Richmond, California cut gun homicides by 70 percent. Oakland's Ceasefire strategy reduced shootings by 50 percent. New York City's Cure Violence program — which treats gun violence like a contagious disease and sends "interrupters" to stop it from spreading — saw gun injuries drop 63 percent in the neighborhoods they served. These aren't pilot programs anymore. They're proven models with years of data.

They work because they address what policing can't: the things that lead to violence in the first place. A police officer arrives after someone has been shot. A violence interrupter arrives before the decision to shoot is made. The interrupter knows the people, knows the tensions, knows the block. They're credible because they're *from* the community — not assigned to it.
...
This connects directly to [mental health](/foundation/mental-health/) — living with chronic violence and the constant threat of violence produces PTSD (post-traumatic stress disorder — the same condition that affects combat veterans), anxiety, depression, and substance use at rates far above the general population. A kid who grows up hearing gunshots at night develops the same stress markers as a kid in a war zone. We know this. We've studied it. We just haven't built anything in response.

It connects to [safe spaces](/foundation/safe-spaces/) — the absence of physical safety in a community eliminates every other kind of safe space. You can't build a community center that works when people are afraid to walk to it. You can't run an after-school program when parents are afraid to let their kids stay.

And it connects to [housing](/foundation/housing/) — the neighborhoods with the highest violence are the neighborhoods where money stopped flowing decades ago. Abandoned buildings become staging grounds. Lack of street lighting creates opportunities. The physical shape of neglect produces the conditions for harm. You can't police your way out of a housing crisis. You can't arrest your way out of decades of abandonment. You can only rebuild — and that requires treating safety as what it actually is: infrastructure, not enforcement.
...
And it means being honest about what AI changes. AI introduces real threats — deepfake harassment (AI-generated fake images and videos used to intimidate or blackmail), bias baked into policing algorithms that claim to predict where crime will happen but really just send more officers to neighborhoods that were already over-policed, and surveillance systems that watch entire populations with no one accountable for what they do with the information. But AI also offers real possibilities: early warning systems that spot domestic violence escalation before it becomes homicide, environmental monitoring that catches a chemical leak before it poisons the water, communication tools that reduce the misunderstanding that leads to conflict. The question is whether these tools serve communities or control them. And right now, the people making that choice are mostly not the communities who'll live with the consequences.
...
- **Restorative justice at scale.** "Restorative justice" means something specific: instead of asking "what law was broken and how do we punish?" it asks "who was harmed and how do we repair it?" It's a structured alternative to prison for non-violent offenses that keeps communities intact while holding people accountable for the damage they've caused. Oklahoma spends roughly $34,000 per year per incarcerated person with a 75 percent return rate. What would we get if we invested that same money in repairing the conditions that produce crime instead of warehousing the people caught in them?
...
Have ideas about Safety? [Share them in our community discussion →](https://github.com/dabirdwell/humanity-and-ai/discussions/49)
