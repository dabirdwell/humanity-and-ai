---
title: "Education"
description: "Not job training. Not test prep. Education as the lifelong infrastructure of a free mind."
number: "02"
weight: 2
status: "seed"
...
Here's a number that should be in every school board presentation in the country. Andrej Karpathy — one of the engineers who helped build modern AI at OpenAI and Tesla — recently mapped every major US job category by how much AI is likely to change or replace the work involved. The average score across the entire economy: 5.3 out of 10. Software engineers — the career path guidance counselors across America have been steering kids toward for twenty years — scored 8 to 9. Roofers scored near zero.

Let that sit for a second. The jobs most exposed to AI aren't the ones we feared — factory floors, truck routes, warehouse lines. They're the desk jobs — the ones that require writing, analysis, coding, research. The ones we told an entire generation to go into debt for. The ones the current education system is *still* optimized to produce workers for.
