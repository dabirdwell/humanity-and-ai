---
title: "Skills Training & Education Evolution"
description: "Continuous retraining as a right, not a privilege. Because the economy won't stop changing, and people need to keep up."
number: "12"
weight: 12
status: "seed"
tags: ["foundation", "skills", "education", "workforce", "foundation", "policy"]
hero_stat: "Andrej Karpathy mapped every major US job category by AI exposure. The average score: 5.3 out of 10. Software engineers — the career we told a generation to pursue — scored 8 to 9. The US spends less than half what it did in the 1990s on job transition programs."
...
The McKinsey Global Institute has estimated 400 to 800 million workers globally could be displaced by automation by 2030. Even the low end of that range dwarfs any workforce disruption in human history. And the US response? We spend less than half what we did in the 1990s on job transition programs, adjusted for inflation. The scale of the problem is multiplying. The scale of the response is shrinking.

## Oklahoma's Version of This

Oklahoma's economy is concentrated in sectors — energy, healthcare, logistics, back-office operations — that sit squarely in AI's crosshairs. Tulsa has actively courted remote tech workers through programs like Tulsa Remote, offering $10,000 to relocate. But that brings in people who already have the skills. It doesn't help the people who are already here and losing the jobs they trained for.

The state's workforce development system runs primarily through Oklahoma Works and the CareerTech system — which are genuinely good at what they were designed for. The problem is what they were designed for: a labor market that moved slowly enough for a certificate program to be relevant by the time you finished it. When AI can collapse an industry's hiring needs in eighteen months — the timeline Dennis experienced — a two-year certificate program is already out of date before the first class finishes.

And the numbers on the ground: the share of working-age Oklahomans who actually have jobs or are looking for them lags the national average. Median household income is roughly $59,000 — well below the national median of $80,000. Over 15 percent of Oklahomans live below the poverty line. These aren't people with a cushion. They can't afford to stop working for two years to retrain. They can't absorb a pay cut from $25 an hour to $14 while they learn a new stack. The retraining has to meet them where they are — financially, geographically, and in terms of the skills they already have.
...
Here's what connects Dennis staring at a brochure, the 83 million workers whose jobs are evaporating, and the guidance counselor still telling kids to learn to code.

When you lose your work — not just your job, but your sense of being competent at something the world needs — it doesn't just affect your income. It reorganizes your identity. Work in America isn't just economic. It's how people answer the question *what do you do?* — which is really the question *who are you?* When the answer disappears, the ground moves under everything.

Your nervous system registers it as threat. Stress hormones rise. Sleep fractures. Decision-making narrows to the immediate — not because you've lost your intelligence, but because your body has correctly identified that the thing that provided stability, purpose, and identity is gone. Long-term planning becomes impossible when you don't know what you're planning *for*. And the longer that state persists, the harder it becomes to climb out of, because the stress itself degrades the cognitive flexibility you'd need to adapt.

This connects to [universal basic income](/foundation/universal-basic-income/) directly — economic security during transition isn't a luxury. It's the difference between a person who can retrain and a person who takes the first $14-an-hour job they can find because the mortgage is due. When the floor holds, people can think. When it doesn't, they survive. And survival mode doesn't produce the kind of adaptive, creative workforce a transformed economy needs.

It connects to [information access](/foundation/information-access/) — you can't retrain for the jobs that are coming if you can't access the tools that teach them. When the best AI tutoring, the best learning platforms, the best professional development tools are locked behind subscriptions that cost more than Dennis can afford on unemployment, the skills gap isn't about ability. It's about access.

And it connects to [education](/foundation/education/) — because the skills training crisis is downstream of an education system that never taught people how to learn. It taught them how to perform tasks. When the tasks change, people who were taught *how to think* adapt. People who were taught *what to do* freeze. The education system we have produces the second kind at industrial scale.

## What We're Building

Foundation's approach to skills training starts with a principle: continuous adaptation is a citizenship right, not a market product. The ability to develop new capabilities throughout your life — not just when you're young enough for it to count as "education" — is as fundamental as healthcare or housing. Because in an economy that won't stop changing, the ability to change with it is the difference between participation and abandonment.

That means:

Lifelong learning accounts — every citizen gets resources they can use at any age, at any accredited program, for any skill. No expiration. No income requirements — you don't have to prove you're poor enough to qualify. If Karpathy's right that the average job is at 5.3 out of 10 AI exposure, this isn't a perk. It's survival infrastructure for an economy that will never stop reshaping itself.
...
And it means training for the skills that actually matter now. Not just technical skills — though those matter — but the capacities that hold a society together and that AI can't replace: ethical reasoning, conflict resolution, mentorship, care work, community organizing, creative synthesis, civic participation. These are the human skills that guide how AI tools get used, and by whom, and for what purpose. We systematically undervalue and underfund training in exactly these areas while over-investing in skills that AI is about to make cheap and abundant. That has to reverse.

## What We Need From You

Those who say the market will handle workforce transition are the same ones whose market left Dennis with a brochure. The market doesn't retrain people — it replaces them. The question is whether we build the infrastructure that keeps people in the game, or whether we let an entire generation fall through the floor and then blame them for not jumping.
