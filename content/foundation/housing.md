...
Housing instability tracks with [food](/foundation/food/) insecurity — the neighborhoods where people can't afford to live are the same neighborhoods where there's no grocery store within walking distance. Food deserts and housing deserts overlap on the map so precisely it looks intentional. And the [economic framework](/foundation/economic-framework/) that Foundation proposes can't function if people are spending 50, 60, 70 percent of their income on shelter before they buy groceries, before they see a doctor, before they do anything else. Housing is the platform. Without it, nothing else stands.
