...
**Stockton, California — the SEED program.** 125 residents received $500 a month for two years, no strings attached. Full-time employment among recipients rose 12 percent — they found full-time work at more than twice the rate of the control group. Income volatility dropped by half. The amount of ready cash people had on hand was 24 percent higher. Spending went to food (37 percent), merchandise (22 percent), utilities (11 percent), and auto costs (10 percent). Less than 1 percent went to alcohol or tobacco. Less than one percent. Mental health improved significantly — less anxiety, less depression, more capacity to plan.

**Finland — the national experiment.** 2,000 long-term unemployed received 560 euros a month unconditionally for two years. Employment improved modestly — six more working days per year, concentrated among parents. But the health effects were striking: prescriptions for psychiatric medication dropped 8 to 11 percent. Outpatient mental health visits declined. Participants reported being happier and healthier. The income floor didn't make people lazy. It made them *well enough to function*.
...
Then look at where the new wealth is being generated. AI-driven productivity gains are producing enormous value — but that value is flowing to the people who own the companies and the machines, not to the workers whose labor the AI replaces. Goldman Sachs projects that generative AI could expose the equivalent of 300 million full-time jobs globally to automation, while boosting the total value of the world's economic output by 7 percent. That's wealth creation at unprecedented scale, flowing to an unprecedented few. The Society for Human Resource Management found that 23.2 million American jobs — 15.1 percent of employment — already have more than half their tasks automated. The World Economic Forum projects 92 million jobs displaced by 2030, offset by 170 million new ones created — but the people losing the old jobs and the people getting the new ones are not the same people, and the transition between them is where lives break.
...
Specific mechanisms include taxing AI-driven automation (taxing automated productivity at rates comparable to the labor it replaces), a small tax on Wall Street trades, putting a price on carbon emissions, and redirecting the money we're already spending on welfare programs that cost more to run than they deliver. The economic modeling suggests it's feasible. The question has always been political will, not arithmetic. We are the wealthiest civilization in human history. The whole earth is independently wealthy, and we need to remind it of that.
...
It doesn't fix [education](/foundation/education/) systems that fail to teach critical thinking. It doesn't build the [clean water](/foundation/clean-water/) infrastructure that $625 billion in deferred maintenance demands. It doesn't create [safe spaces](/foundation/safe-spaces/) for the person whose abuser controls their finances — though it gives that person resources independent of the abuser, which matters enormously. It doesn't solve [mental health](/foundation/mental-health/) crises that require therapeutic infrastructure, not just money. It doesn't build [transportation](/foundation/transportation/) networks in places where there's no bus. It doesn't protect [thought privacy](/foundation/thought-privacy/) or guarantee [information access](/foundation/information-access/) or establish the [social contract](/foundation/social-contract/) that makes all of this coherent.
