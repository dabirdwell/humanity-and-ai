---
title: "Social Contract Reevaluation"
description: "The deal between citizens and society was written for a world that no longer exists. Time to renegotiate."
number: "04"
weight: 4
status: "seed"
tags: ["foundation", "social-contract", "governance", "foundation", "policy"]
hero_stat: "Only 17% of Americans trust the federal government to do the right thing. In 1964, it was 77%. Neither party has a plan for what comes next — not a real plan, not one built on a cohesive understanding of the world that's arriving."
...
**What society owes the citizen:** A floor. Not a ceiling — a floor. The sixteen components of this framework are the floor: [safety](/foundation/safety/), [education](/foundation/education/), [housing](/foundation/housing/), [healthcare](/foundation/healthcare/), [food](/foundation/food/), [clean water](/foundation/clean-water/), [mental health support](/foundation/mental-health/), [information access](/foundation/information-access/), [skills training](/foundation/skills-training/), economic security, [safe spaces](/foundation/safe-spaces/), sustainable energy, transportation, [thought privacy](/foundation/thought-privacy/), and the governance mechanisms that hold all of it together. These aren't luxuries. They're the minimum conditions for participation. A society wealthy enough to provide them — and we are, overwhelmingly — has no excuse not to.

**What the citizen owes society:** Participation. Not just labor — participation. Informed civic engagement. Community contribution. The willingness to learn, adapt, and contribute your creativity, care, and governance capacity to the collective project. In a world where machines handle routine production, human contribution shifts from output to stewardship. That's not a demotion. That's an elevation — but it requires a population prepared for it, which is why [education](/foundation/education/) and [skills training](/foundation/skills-training/) are not optional in this framework. They're load-bearing.
