---
title: "Mental Health & Addiction Support"
description: "Comprehensive care for the mind, not just the body. Because the transition ahead will break people who don't have support."
number: "09"
weight: 9
status: "seed"
tags: ["foundation", "mental-health", "healthcare", "foundation", "policy"]
hero_stat: "170 million Americans live in areas with a shortage of mental health professionals. The average person waits 11 years between their first symptoms and their first treatment."
...
Marcus is not an edge case. He is the system working as designed — a system that treats mental healthcare as an afterthought, funds it like a luxury, and then acts surprised when people break.

Foundation is built on a simple premise: there is a minimum set of conditions people need to thrive, and a society wealthy enough to provide them has no excuse not to. Mental health support is one of [sixteen components](/foundation/) in this framework — broken out separately from [healthcare](/foundation/healthcare/) because America systematically treats it as secondary. That treatment is itself a design choice. And we can make a different one.
...
Fifty-nine million adults — nearly one in four — experienced mental illness in the past year. About 15 million of them had serious mental illness. And the average time between when a person first develops symptoms and when they first receive treatment is *eleven years*. Eleven years of managing alone, of compensating, of the quiet erosion of relationships and capacity and hope that happens when something is wrong and there's no one to call.
...
AI can help. It can triage. It can extend a therapist's reach to patients who'd otherwise wait months. It can detect crisis signals and connect people to humans immediately. But it's a tool in a system, not a replacement for the system. And right now, we're using it as a patch over a hole when what we need is to build the floor.
...
And it cascades. Untreated mental health drives [healthcare](/foundation/healthcare/) costs — emergency rooms are the most expensive and least effective place to treat a mental health crisis, and they've become the default. It connects to [housing](/foundation/housing/) — housing instability causes mental health crises, and mental health crises cause housing instability, a feedback loop that eats people alive. It connects to [education](/foundation/education/) — kids who can't access a school counselor fall behind, and falling behind produces the anxiety and depression that needed the counselor in the first place.
...
Foundation's mental health component treats comprehensive psychological support as a citizenship right — accessible, destigmatized, evidence-based, and integrated with the broader [healthcare](/foundation/healthcare/) infrastructure. Not an add-on. Not a carve-out. Mental health IS health, and the system should reflect that.
...
- **AI-assisted triage that connects, not replaces.** Chatbots that can identify crisis signals and connect people to human therapists immediately — available 24/7, in every zip code, in every language. Not a replacement for the therapeutic relationship. A bridge to it. What would this look like in your community? What would it take for you to trust it?
