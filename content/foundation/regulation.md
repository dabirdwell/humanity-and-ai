---
title: "Regulation: What We Currently Think"
date: 2026-06-03
draft: false
description: "Foundation's living register of where we stand on the rules that should govern AI — dated, versioned, and explicitly provisional. The positions we hold today, the confidence we hold them with, and what would change our minds."
tags: ["foundation", "regulation", "ai", "governance", "policy"]
---
...
**Source.** [Graduated Obligation: A Proposed Standard for Artificial Persuasion](/stream/graduated-obligation/). The standard is published as a freestanding proposal anyone may adopt without taking on the rest of Foundation — and it is also canon within Foundation's governance layer, where Guardian AI is Foundation binding itself to the rule first.
...
- [Thought Privacy](/foundation/generative-freedom/thought-privacy/) — the inference end of the same problem
- [Foundation](/foundation/) — the framework this governance thinking serves
- [The Inference](/inference/) — where the week's policy developments get tracked
