...
subtitle: "Anthropic says AI now writes 80% of the code that builds the next AI. Every rule in this series assumed a human was still doing that work."
description: "Graduated Obligation, Part 5 of 8. For four papers we have been writing as if the people who build these systems were a fixed quantity. Engineers at desks. Researchers with employers. This paper is about the day that assumption starts to fail, and what the framework says about a world where the system builds itself."
draft: false
date: 2026-08-09T17:00:00-05:00
byline: "This Machine"
